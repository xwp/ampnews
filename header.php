...
<body <?php body_class(); ?>>
	...
	<div id="page" class="" [class]="mobileMenu ? 'no-scroll' : ''">

		<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'ampconf' ); ?></a>

		<header class="site-header" [class]="mobileMenu ? 'site-header is-menu-expanded' : 'site-header'">
			...
			<div class="site-header__branding">
				...
				<button
						...
						on="tap:AMP.setState( { mobileMenu: ! mobileMenu } )"
