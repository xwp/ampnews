...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( 'entry wrap__item' ); ?> data-sort-time="<?php echo esc_attr( get_the_date( 'U' ) ); ?>" data-update-time="<?php echo esc_attr( get_the_modified_time( 'U' ) ); ?>">
