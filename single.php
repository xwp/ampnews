	...
	while ( have_posts() ) :
		...
		<div class="wrap">
			<main class="wrap__item wrap__item--full-width">
				<amp-live-list id="ampnews-live-post-<?php the_ID(); ?>" class="live-list" data-poll-interval="<?php echo esc_attr( AMPCONF_LIVE_LIST_POLL_INTERVAL ); ?>" data-max-items-per-page="1">
