<?php
/**
 * AMPNews static widget categories template.
 *
 * @package AMPNews
 */
...
<section id="categories-5" class="widget widget_categories"><h2 class="widget-title">Test Categories Widget: With
	...
	<form action="http://ampnews.local" method="get" novalidate="" class="i-amphtml-form"><label
			...
			<option class="level-0" value="2">Alignment&nbsp;&nbsp;(3)</option>
			<option class="level-0" value="3">Aside&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="4">Audio&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="5">Captions&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="6">Chat&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="7">Codex&nbsp;&nbsp;(3)</option>
			<option class="level-0" value="8">Comments&nbsp;&nbsp;(6)</option>
			<option class="level-0" value="9">Content&nbsp;&nbsp;(11)</option>
			<option class="level-0" value="10">Corner Case&nbsp;&nbsp;(4)</option>
			<option class="level-0" value="11">Embeds&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="12">Excerpt&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="13">Featured Images&nbsp;&nbsp;(3)</option>
			<option class="level-0" value="14">Formatting&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="15">Gallery&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="16">Images&nbsp;&nbsp;(7)</option>
			<option class="level-0" value="17">Jetpack&nbsp;&nbsp;(3)</option>
			<option class="level-0" value="18">Link&nbsp;&nbsp;(3)</option>
			<option class="level-0" value="19">Lists&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="20">Markup&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="21">More Tag&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="22">Parent Category&nbsp;&nbsp;(1)</option>
			<option class="level-1" value="37">&nbsp;&nbsp;&nbsp;Child Category 01&nbsp;&nbsp;(1)</option>
			<option class="level-1" value="38">&nbsp;&nbsp;&nbsp;Child Category 02&nbsp;&nbsp;(1)</option>
			<option class="level-1" value="39">&nbsp;&nbsp;&nbsp;Child Category 03&nbsp;&nbsp;(1)</option>
			<option class="level-2" value="42">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grandchild Category&nbsp;&nbsp;(1)</option>
			<option class="level-1" value="40">&nbsp;&nbsp;&nbsp;Child Category 04&nbsp;&nbsp;(1)</option>
			<option class="level-1" value="41">&nbsp;&nbsp;&nbsp;Child Category 05&nbsp;&nbsp;(1)</option>
			<option class="level-0" value="23">Password&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="24">Pingbacks&nbsp;&nbsp;(4)</option>
			<option class="level-0" value="25">Post Formats&nbsp;&nbsp;(13)</option>
			<option class="level-0" value="26">Quote&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="27">Shortcodes&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="28">Standard&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="29">Status&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="30">Sticky&nbsp;&nbsp;(1)</option>
			<option class="level-0" value="31">Titles&nbsp;&nbsp;(5)</option>
			<option class="level-0" value="32">Trackbacks&nbsp;&nbsp;(4)</option>
			<option class="level-0" value="33">Twitter&nbsp;&nbsp;(2)</option>
			<option class="level-0" value="1">Uncategorized&nbsp;&nbsp;(3)</option>
			<option class="level-0" value="34">Unpublished&nbsp;&nbsp;(1)</option>
			<option class="level-0" value="35">Video&nbsp;&nbsp;(3)</option>
			<option class="level-0" value="36">VideoPress&nbsp;&nbsp;(2)</option>
		</select>
	</form>
